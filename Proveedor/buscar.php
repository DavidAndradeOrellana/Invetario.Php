...
$sql = "SELECT * FROM proveedor WHERE nomprovee LIKE '%$buscar%'";
...
<br><br>
  <div class="form-group">
    <div class="col-lg-offset-2 col-lg-10">
       ...
       <a href="proveedor.php" class="btn btn-large btn-info"></i> &nbsp; Regresar</a>
    </div>
  </div>
</body>
