...
<div class="container">
	 ...
	 if(isset($_GET['Idmarca']))
	 {
         ...
         <?php
         $stmt = $DB_con->prepare("SELECT * FROM marca WHERE Idmarca=:Idmarca");
         $stmt->execute(array(":Idmarca"=>$_GET['Idmarca']));
...
if(isset($_GET['Idmarca']))
{
    ...
    <a href="marca.php" class="btn btn-large btn-success"><i class="glyphicon glyphicon-backward"></i> &nbsp; NO</a>
    </form>   
	<?php
}
else
{
	?>
    <a href="marca.php" class="btn btn-large btn-success"><i class="glyphicon glyphicon-backward"></i> &nbsp; Regresar</a>
    <?php
}
?>
</p>
