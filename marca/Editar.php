...
<div class="container">
    ...
    <div class="col-lg-3">
      <input type="text"  onkeyup = "this.value=this.value.toUpperCase()"onkeypress="return sololetras(event)" onpaste="return false" class="form-control"  name="nommarca" id="nombre"
             placeholder="Nombre de una MARCA" class="remote" value="<?php echo $nommarca; ?>" required>
    </div>
  </div><br><br>
  <div class="form-group">
    <div class="col-lg-offset-2 col-lg-10">
        <button type="submit" class="btn btn-primary" name="btn-update">
    		<span class="glyphicon glyphicon-edit"></span> Modificar
			 ...
			 <a href="marca.php" class="btn btn-large btn-success"><i class="glyphicon glyphicon-backward"></i> &nbsp; Cancelar</a>
    </div>
  </div>
