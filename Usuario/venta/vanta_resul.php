...
<body>
  ...
  <div class="center">
    ...
    <div id="menu">
      <ul>
        <li><a class="active" href="/Inventario/principal.php"><span>Inicio</span></a></li>
...
<div class="form-group">
    ...
    <label for="marca"  class="col-lg-2 control-label">Vencimiento</label>
     <div class="col-lg-4">
                    ...
                    <input type="text"  name="fecha" id="fechac"  value="<?php echo $fe; ?>"class="required form-control" required >
...
if (isset($_GET['Idproducto'])) {
    ...
    $results = $stmt->execute(array($_GET['Idproducto']));
    $row = $stmt->fetch();
    if (empty($row)) {
  ...
  if (array_key_exists('btn-save', $_POST)) {
    ...
    $stmt = $conn->prepare($sql);
    $OK = $stmt->execute(array($_POST['actual'],$_GET['id']));
