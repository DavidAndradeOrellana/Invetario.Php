...
<div id="toprowsub">
  <div class="center">
    <h2>MODIFICAR USUARIO O ADMINISTRADOR</h2>
...
<div class="container">
    ...
    <div class="col-lg-3">
      <input type="text"  onkeypress="return sololetras(event)" onpaste="return false" class="form-control"  name="nombre" id="nombre"
             placeholder="Ingrese usuario" class="remote" value="<?php echo $nombre; ?>"required>
    </div><br><br>
      <div class="form-group">
    <label for="usuario" class="col-lg-2 control-label">Administrador </label>
    <div class="col-lg-3">
      <input type="password" class="form-control"  name="administrador" id="nombre"
             placeholder="Ingrese una contraseña" class="remote" value="<?php echo $administrador; ?>">
    </div>
  </div><br><br>
  <div class="form-group">
    <label for="usuario" class="col-lg-2 control-label">Usuario</label>
    <div class="col-lg-3">
      <input type="password" class="form-control"  name="normal" id="nombre"
             placeholder="Ingrese una contraseña" class="remote" value="<?php echo $normal; ?>">
    </div>
  </div><br><br>
  <div class="form-group">
    <div class="col-lg-offset-2 col-lg-10">
       ...
       <a href="usuario.php" class="btn btn-large btn-success"><i class="glyphicon glyphicon-backward"></i> &nbsp; Cancelar</a>
    </div>
  </div>
