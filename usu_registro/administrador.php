...
<a href="registro1.php" class="btn btn-large btn-info"><i class="glyphicon glyphicon-plus"></i> &nbsp; Nuevo Administrador</a>
...
<div class="container">
     ...
     <?php
		$query = "SELECT idusuario,nombre, administrador FROM `usuario` WHERE administrador IS NOT NULL";       
		$records_per_page=8;
